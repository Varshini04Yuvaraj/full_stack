...
import com.party.party.model.Loginfile;
import com.party.party.model.Sign;
import com.party.party.model.Signfile;
import com.party.party.repository.SignRepository;
import com.party.party.service.SignService;
...
public class SignController {
    ...
    @Autowired
    public SignController(AuthenticationManager authenticationManager) {
    ...
    public ResponseEntity<Object> loginUser(@Valid @RequestBody Loginfile loginDto, BindingResult result) {
        ...
        try {
            ...
            Sign userModel = repository.findByEmail(loginDto.getEmail());
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Sign> getUserById(@PathVariable Long id) {
    ...
    private String createJwtToken(Sign userModel) {
